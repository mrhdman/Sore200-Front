      ...
      <Router>
        <div className='BrowseWorkoutsContainer'>
          ...
          <div className='workoutButtons'>
            <Link to='/workout/browse/personal'>
              <button className='personalButton'>
                <h2>PERSONAL</h2>
              </button>
            </Link>
            <Link to='/workout/browse/global'>
          ...
          <div className='workoutRoutes'>
            <Route
              exact
              path='/workout/browse/personal'
              component={PersonalWorkouts}
            />
            <Route
              exact
              path='/workout/browse/global'
              component={GlobalWorkouts}
            />
          </div>
        </div>
      </Router>
